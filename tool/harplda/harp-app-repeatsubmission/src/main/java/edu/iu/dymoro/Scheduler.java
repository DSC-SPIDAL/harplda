...
public class Scheduler<D, S extends Simple, T extends MPTask<D, S>> {
  ...
  private final int SUBMISSION_LEVEL = 10;
          ...
          for (int i = 0; i < numFreeCols; i++) {
            ...
            if (submissionMap[freeRowID][freeCol[i]] > 0) {
              ...
              if (count == 1) {
                ...
                .nextInt(count) < submissionMap[freeRowID][freeCol[i]] ) {
                selectedColIndex = i;
              }
            }
          }
          ...
          for (int i = 0; i < numFreeRows; i++) {
            ...
            if (submissionMap[freeRow[i]][freeColID] > 0) {
              ...
              if (count == 1) {
                ...
                .nextInt(count) < submissionMap[freeRow[i]][freeColID]) {
                selectedRowIndex = i;
              }
            }
          }
    ...
    for (int i = 0; i < numRowSplits; i++) {
      for (int j = 0; j < numColSplits; j++) {
        ...
        //if (submissionMap[i][j]) {
          ...
          submissionMap[i][j] = MAXSUBMISSION * SUBMISSION_LEVEL;
        //}
      }
    }
  }
