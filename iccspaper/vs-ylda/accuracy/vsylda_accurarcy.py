...
def draw_single():
    ...
    call_plot('accuracy_iter', 'data', 'vsylda-accuracy.100-clueweb-ib', 'accuracy_iter_ib.clueweb.svg', "LDA Trainers Accuracy on Clueweb Dataset,IB")
    ploter.init_subplot(1,1)
    ploter.set_subplot(1,1)
 
    call_plot('accuracy_runtime', 'data', 'vsylda-accuracy.100-clueweb-ib', 'accuracy_runtime_ib.clueweb.svg', "LDA Trainers Accuracy on Clueweb Dataset,IB")
    ploter.init_subplot(1,1)
    ploter.set_subplot(1,1)
 
    call_plot('accuracy_iter','data', 'vsylda-accuracy.100-clueweb-eth', 'accuracy_iter_eth.clueweb.svg', "LDA Trainers Accuracy on Clueweb Dataset,Ethernet")
    ploter.init_subplot(1,1)
    ploter.set_subplot(1,1)
 
    call_plot('accuracy_runtime', 'data', 'vsylda-accuracy.100-clueweb-eth', 'accuracy_runtime_eth.clueweb.svg', "LDA Trainers Accuracy on Clueweb Dataset,Ethernet")
    ploter.init_subplot(1,1)
    ploter.set_subplot(1,1)
 
    
    # enwiki
    call_plot('accuracy_iter','data','vsylda-accuracy.100-enwiki-ib','accuracy_iter_ib.enwiki.svg',"LDA Trainers Accuracy on enwiki Dataset,IB")
    ploter.init_subplot(1,1)
    ploter.set_subplot(1,1)
 
    call_plot('accuracy_runtime', 'data','vsylda-accuracy.100-enwiki-ib','accuracy_runtime_ib.enwiki.svg',"LDA Trainers Accuracy on enwiki Dataset,IB")
    ploter.init_subplot(1,1)
    ploter.set_subplot(1,1)
        
    call_plot('accuracy_iter', 'data','vsylda-accuracy.100-enwiki-eth','accuracy_iter_eth.enwiki.svg',"LDA Trainers Accuracy on enwiki Dataset,Ethernet")
    ploter.init_subplot(1,1)
    ploter.set_subplot(1,1)
  
    call_plot('accuracy_runtime', 'data','vsylda-accuracy.100-enwiki-eth','accuracy_runtime_eth.enwiki.svg',"LDA Trainers Accuracy on enwiki Dataset,Ethernet")
