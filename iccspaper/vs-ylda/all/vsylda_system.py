...
def draw_all():
    ...
    call_plot('network', '../../data', 'vsylda-accuracy.100-clueweb-ib', '', "Clueweb Dataset, 16Gbps Infiniband")
    ploter.set_subplot(2,1)
    call_plot('freemem', '../../data', 'vsylda-accuracy.100-clueweb-ib', '', "Clueweb Dataset, 16Gbps Infiniband")
    ploter.set_subplot(3,1)
    call_plot('cpu', '../../data', 'vsylda-accuracy.100-clueweb-ib', '', "Clueweb Dataset, 16Gbps Infiniband")


    ploter.set_subplot(1,2)
    call_plot('network','../../data', 'vsylda-accuracy.100-clueweb-eth', '', "Clueweb Dataset, 1Gbps Ethernet")
    ploter.set_subplot(2,2)
    call_plot('freemem', '../../data', 'vsylda-accuracy.100-clueweb-eth', '', "Clueweb Dataset, 1Gpbs Ethernet")
    ploter.set_subplot(3,2)
    call_plot('cpu', '../../data', 'vsylda-accuracy.100-clueweb-eth', '', "Clueweb Dataset, 1Gpbs Ethernet")
