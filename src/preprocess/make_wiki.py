...
if __name__ == '__main__':
    ...
    if online:
        ...
        logger.info("save all bow model")
        MmCorpus.serialize(outp + '_all_bow.mm', wiki, progress_cnt=10000) # another ~9h
        wiki.dictionary.save_as_text(outp + '_all_wordids.txt.bz2')
    
    
        logger.info("save flltered bow model")
        wiki.dictionary.filter_extremes(no_below=3, no_above=0.1, keep_n=keep_words)
