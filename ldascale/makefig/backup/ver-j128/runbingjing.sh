...
python plotall.py enwiki_opt/knl_lda_opt_enwiki_convergence.conf 
python plotall.py enwiki_opt/hsw72_lda_opt_enwiki_convergence.conf 
cp enwiki_opt/*.pdf ~/tmp/bingjing
