...
from plot_init import draw_init, dataroot
...
def draw_newharp(conffile, conf):
    ...
    ploter.set_subplot(1,1)
    ploter.curax.grid(gridFlag)
    call_plot('accuracy_overalltime', dataroot, conffile, '-1-1.pdf',conf) 

    ploter.init_subplot(1,1)
    ploter.set_subplot(1,1)
    ploter.curax.grid(gridFlag)
    call_plot('accuracy_runtime', dataroot, conffile, '-1-2.pdf',conf) 

    ploter.init_subplot(1,1)
    ploter.set_subplot(1,1)
    ploter.curax.grid(gridFlag)
    call_plot('accuracy_iter', dataroot, conffile, '-1-3.pdf',conf) 
    ploter.init_subplot(1,1)
    ploter.set_subplot(1,1)
    ploter.curax.grid(gridFlag)
    call_plot('accuracy_itertime', dataroot, conffile, '-1-4.pdf',conf) 


    ploter.init_subplot(1,1)
    ploter.set_subplot(1,1)
    call_plot('overhead', dataroot, conffile, '-3-2.pdf', nullconf)
    ploter.init_subplot(1,1)
    ploter.set_subplot(1,1)
    call_plot('overhead_end', dataroot, conffile, '-3-3.pdf', nullconf)
    ploter.init_subplot(1,1)
    ploter.set_subplot(1,1)
    ploter.curax.grid(gridFlag)
    call_plot('overhead_all', dataroot, conffile, '-3-4.pdf', conf)

    ploter.init_subplot(1,1)
    ploter.set_subplot(1,1)
    ploter.curax.grid(gridFlag)
    call_plot('loadbalance_runtime', dataroot, conffile, '-2-3.pdf', conf)
    
#ploter.init_subplot(1,1)
#ploter.set_subplot(1,1)
#call_plot('overall_runtime', dataroot, conffile, '-4-4.pdf', '')
    ploter.init_subplot(1,1)
    ploter.set_subplot(1,1)
    ploter.curax.grid(gridFlag)
    call_plot('scalability', dataroot, conffile, '-throughput-2.pdf',conf) 


    ploter.init_subplot(1,1)
    ploter.set_subplot(1,1)
    ploter.curax.grid(gridFlag)
    call_plot('throughput_runtime', dataroot, conffile, '-throughput-1.pdf',conf) 


    ploter.init_subplot(1,1)
    ploter.set_subplot(1,1)
    ploter.curax.grid(gridFlag)
    call_plot('converge_level', dataroot, conffile, '-converge-bar-1.pdf',conf) 
